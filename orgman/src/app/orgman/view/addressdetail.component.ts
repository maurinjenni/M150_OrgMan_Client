...
export class AddressDetailComponent implements OnInit, OnDestroy {
    ...
    constructor(private breadcrumbService: BreadcrumbService, private route: ActivatedRoute,
        private confirmationService: ConfirmationService, private router: Router, private addressService: AddressService,
        private membershipService: MembershipService, private mandatorService: MandatorService) {}
    ...
    loadAddress() {
        this.addressService.getByUid(this.currentAddressId).then((response) => {
            ...
            this.currentAddress.MemberInformation.EntryDate =
              new Date(datePipe.transform(this.currentAddress.MemberInformation.EntryDate, 'MM/dd/yyyy'));
            this.currentAddress.MemberInformation.ExitDate =
              new Date(datePipe.transform(this.currentAddress.MemberInformation.ExitDate, 'MM/dd/yyyy'));
